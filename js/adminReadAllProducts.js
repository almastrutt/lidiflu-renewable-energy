...
$(document).ready(function(){
    ...
    //show the list of product when the page loads
     showProducts();
    
});

function showProducts (){
    //Call REST API to ge the list of products
    
    $.getJSON('https://graded-unit-almastrutt01.c9users.io/products/read.php', function (data){
