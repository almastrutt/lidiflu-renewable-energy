$(document).ready(function(){
    ...
    $(document).on('click', '.update-product-button', function(){
        ...
        $.getJSON("https://graded-unit-almastrutt01.c9users.io/products/readone.php?id="+id, function(data){
       ...
       var image_path = data.image_path;
        ...
        update_product +="<td><input value=\"" + price + "\" type='number' min='1' name='price' step='.01' class='form-control' required /></td>";
        update_product +="</tr>";
    ...
    $(document).on('submit', '#update-product-form', function(){
         ...
         $.ajax({
          url: "https://graded-unit-almastrutt01.c9users.io/products/update.php",
         type: "POST",
